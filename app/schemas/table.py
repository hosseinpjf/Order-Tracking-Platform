...
class CreateTable(BaseModel):
    ...
    image: str = Field(..., pattern=r"^/media/uploads/tables/[A-Za-z0-9_\-./]+\.(jpg|jpeg|png|webp)$")
...
class UpdateTable(BaseModel):
    ...
    image: str | None = Field(None, pattern=r"^/media/uploads/tables/[A-Za-z0-9_\-./]+\.(jpg|jpeg|png|webp)$")
